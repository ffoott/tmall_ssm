...
$(function(){
	...
	categoryBtn.addEventListener("mouseover",function (e) {
		categoryMenu.style.opacity="1";
	});
	categoryBtn.addEventListener("mouseleave",function (e) {
		categoryMenu.style.opacity="0";
		categoryMenu.addEventListener("mouseover",function (e) {
			categoryMenu.style.opacity="1";
		});
	});
...
<div class="headbar show1">
	<div class="head ">
		...
		<span style="margin-left:10px" id="categoryBtn">商品分类</span>
